...
export class Service {
    ...
    // humne indexes banayi thi so we can use queries on it. jinka status 'active' hoga wohi get hongi saari nhi.
    ...
    getFilePreview(fileId) {
        try{
            ...
            console.log("config.js, PreviewFile error: ", error);
            return false;
        }
